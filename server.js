...
const SEED_ITEMS = [
  ...
  ["erteblomst", "Erteblomst", "Lathyrus odoratus", "Klatreplante", 3, 3],
  ["stjerneskjerm", "Stjerneskjerm", "Astrantia major", "Staude", 4, 2],
  ["hosta", "Bladlilje", "Hosta", "Skygge", 3, 2],
  ["alunrot", "Alunrot", "Heuchera", "Staude", 3, 2],
  ["hagesmorbukk", "Hagesmørbukk", "Hylotelephium", "Staude", 3, 2],
  ["akeleie", "Akeleie", "Aquilegia", "Staude", 3, 2],
  ["kjempevalmue", "Kjempevalmue", "Papaver orientale", "Staude", 3, 1],
  ["klematis", "Klematis", "Clematis", "Klatreplante", 4, 1],
  ["ridderspore", "Ridderspore", "Delphinium", "Staude", 3, 1],
  ["iris", "Iris", "Iris germanica", "Staude", 3, 2],
  ["lavendel", "Lavendel", "Lavandula angustifolia", "Urter", 2, 3],
  ["sitronverbena", "Sitronverbena", "Aloysia citrodora", "Urter", 4, 1],
  ["thaibasilikum", "Thaibasilikum", "Ocimum basilicum", "Urter", 3, 2],
  ["chili", "Chili", "Capsicum annuum", "Spiselig", 3, 2],
  ["tomat", "Tomatplante", "Solanum lycopersicum", "Spiselig", 2, 3],
  ["jordbar", "Jordbær", "Fragaria", "Spiselig", 2, 4],
  ["bringebaer", "Bringebær", "Rubus idaeus", "Bærbusk", 3, 1],
  ["rips", "Rips", "Ribes rubrum", "Bærbusk", 3, 1],
  ["hortensia", "Hortensia", "Hydrangea", "Busk", 2, 1],
  ["syrin", "Syrin", "Syringa vulgaris", "Busk", 2, 1],
